...
> **Don't have uv?** `curl -LsSf https://astral.sh/uv/install.sh | sh` for Linux / MacOS — see the [uv install docs](https://docs.astral.sh/uv/getting-started/installation/) for other platforms.
